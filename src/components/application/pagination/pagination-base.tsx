...
const PaginationRoot = ({ total, siblingCount = 1, page, onPageChange, children, style, className }: PaginationRootProps) => {
    ...
    // Derived from props, so compute it rather than copying it into state from an effect.
    const pages: PaginationItemType[] = useMemo(() => createPaginationItems(), [createPaginationItems]);
